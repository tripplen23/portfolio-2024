...
<img src="/hermes-architecture.svg" alt="Hermes Architecture" class="w-full rounded-lg my-6" style="background:#020617; padding:12px; border-radius:8px;" />
