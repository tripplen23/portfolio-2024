...
const coursera_aiForEveryone = require("../images/certificates/coursera_aiForEveryone.png");
const f8_jsBasic = require("../images/certificates/f8_jsBasic.png");
const itd_intern = require("../images/certificates/itd_intern.png");
const ofh_cicd = require("../images/certificates/ofh_cicd.png");
const ofh_fullstackWebDevelopment = require("../images/certificates/ofh_fullstackWebDevelopment.png");
const ofh_graphql = require("../images/certificates/ofh_graphql.png");
const ofh_reactNative = require("../images/certificates/ofh_reactNative.png");
const ofh_typescript = require("../images/certificates/ofh_typescript.png");
const vamk_diploma = require("../images/certificates/vamk_diploma.png");
